...
#include "M5StickCPlus.h" //switched from c to cplus
//#include <Arduino.h>
#include <WiFi.h>
//#include <WiFiMulti.h>
...
//const String wifiPrefix="StevenGoPro8";
const String wifiPrefix="GoPro_0665";
const String wifiPassword="Twf-8Y2-Pd6";
